...
class RealizedAnalysisTests(unittest.TestCase):
    ...
    def test_render_realized_section_has_calendar_and_custom_stage_dates(self):
        ...
        self.assertNotIn('data-realized-calendar-mode', section)
        self.assertNotIn('data-calendar-mode="realized"', section)
        self.assertNotIn('data-calendar-mode="float"', section)
        self.assertNotIn('data-calendar-mode="total"', section)
        ...
        self.assertIn("point.daily_float_value", section)
        self.assertIn("hasExplicitDailyFloat", section)
        ...
        self.assertNotIn("当日浮盈变动折", section)
        self.assertIn("当日盈亏折", section)
